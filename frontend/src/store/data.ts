...
class DataStore {
  private users: User[] = [
    ...
    { username: 'hr_user', password: 'password123', department: 'HR', role: 'user' },
    { username: 'sales_user', password: 'password123', department: 'Sales', role: 'user' },
    { username: 'finance_user', password: 'password123', department: 'Finance', role: 'user' }
  ];
  ...
  private faqs: FAQ[] = [
    {
      ...
      answer: "Login to the HR portal, navigate to 'Time Off', and submit a new request with your desired dates.",
      department: "HR",
    ...
    },
    {
      ...
      answer: "The Q1 sales target is $1M, with individual targets available in your Sales Dashboard.",
      department: "Sales",
    ...
    },
    {
      ...
      answer: "Use the Finance Portal to create a new expense report, attach receipts, and submit for approval.",
      department: "Finance",
